...
async def delete_limited(ctx: commands.Context, limit: int):
	channel = ctx.channel
...
async def delete_mine(ctx: commands.Context):
	channel = ctx.channel
	author = ctx.author
...
async def delete_mine_limited(ctx: commands.Context, limit: int):
	channel = ctx.channel
	author = ctx.author
